...
const FileEntry *HeaderSearch::LookupFile(const char *FilenameStart,
  ...
  std::pair<unsigned, unsigned> &CacheLookup =
    LookupFileCache.GetOrCreateValue(llvm::StringRef(FilenameStart, FilenameEnd-FilenameStart)).getValue();
...
LookupSubframeworkHeader(const char *FilenameStart,
  ...
  llvm::StringMapEntry<const DirectoryEntry *> &CacheLookup =
    FrameworkMap.GetOrCreateValue(llvm::StringRef(FilenameStart, SlashPos - FilenameStart));
